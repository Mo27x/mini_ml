...
\newcommand{\question}[3]{%
  \fbox{\parbox{0.95\linewidth}{%
    ...
    % \ifstrempty{#2}{}{\textbf{Reponse: } #2\par}
    \ifstrempty{#2}{}{\textit{\\\textbf{Réponse: }}\par{#2}}

    \ifstrempty{#3}{}{\\\textbf{Difficultés: } #3\par}
  }}
  \\\\
}
...
Mouhamed s'est occupé principalement de la partie parseur et Nathan de la partie
Typage.
